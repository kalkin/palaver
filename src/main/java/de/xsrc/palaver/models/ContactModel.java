...
public class ContactModel {
    ...
    public ContactModel(ConcurrentHashMap<String, XMPPTCPConnection> connections) {
    ...
    public void removeContact(Contact contact) {
        ...
        XMPPTCPConnection connection = connections.get(contact.getAccount());
        executor.submit(() -> {
            try {
    ...
    public Contact addContact(Account account, String jid)
        ...
        XMPPTCPConnection connection = connections.get(account.getJid());
